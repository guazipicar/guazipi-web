...
<!--/web-fonts-->
	<link href='#css?family=Open+Sans:400,600,600italic,300,300italic,700,400italic' rel='stylesheet' type='text/css'>
	<link href='#css?family=Wallpoet' rel='stylesheet' type='text/css'>
	<link href='#css?family=Ubuntu:400,500,700,300' rel='stylesheet' type='text/css'>
<!--//web-fonts-->
</head>
<body>
<!--/banner-section-->
		   ...
		   <div class="header-top">
		    <!-- /header-left -->
				  ...
				  <!-- /sidebar -->
				        <div id="sidebar"> 
						     <h4 class="menu">目录</h4>
							    ...
							    <li><a href="upcoming.html">新车 <i class="glyphicon glyphicon-triangle-bottom"> </i> </a>
							      <ul>
									  <li><a href="find.html"><span>找新车</span></a></li>
									  ...
									  <li><a href="dealer.html"><span>找到经营商</span></a></li>
									  <li class="last"><a href="price.html"><span>道路价格</span></a></li>
								   </ul>
							   </li>
							    ...
							    <li><a href="cars.html">二手车 <i class="glyphicon glyphicon-triangle-bottom"> </i></a>
								  ...
								  <li><a href="used.html">查找二手车</a></li>
									 ...
									 <li class="last"><a href="valuation.html"><span>二手车评估</span></a></li>
									 <li><a href="dealer.html"><span>找到经营商</span></a></li>
					  ...
					  <div class="tag"><a href="#" data-toggle="modal" data-target="#myModal2"><span class="glyphicon glyphicon-log-in"></span> 用户注册</a></div>
					</div>
				  <!-- //header-left -->
		             <div class="search-box">
						<div id="sb-search" class="sb-search">
							<form action="#" method="post">
								<input name="name" class="sb-search-input" placeholder="在这里搜搜看" type="search" id="search">
					    ...
					    <ul>
							...
							<li>
							<a href="#" data-toggle="modal" data-target="#myModal4"><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>所在城市</a></li>
							...
							<div class="login-inner">
								<div class="login-top">
								 <form action="#" method="post">
									...
									<label for="brand"><span></span> 30天自动登录</label>
								</form>
			...
			<div class="banner-info">
			  <h1><a href="index.html">Catchy <span class="logo-sub">Carz</span> </a></h1>
				...
				<p>Eye it – try it – buy it!</p>
			       <form action="#" method="post">
					...
					<select id="country" onchange="change_country(this.value)" class="frm-field required">
						<option value="null"><img src="images/rupee.png" alt=" " class="img-responsive" />车型</option>
				...
				<div class="section_room">
					<select id="country" onchange="change_country(this.value)" class="frm-field required">
						<option value="null"><img src="images/rupee.png" alt=" " class="img-responsive" /> 价格</option>
									...
									<p>Catchy Carz Brand VL in New York</p>
										<form action="#" method="post">
											<select id="country5" onchange="change_country(this.value)" class="frm-field required">
												<option selected="selected" value="-1">-购买时间-</option>
												<option value="0">只是看看</option>
...
<!--//banner-section-->
	...
	<div class="featured_section_w3l">
		<div class="container">
		      <h3 class="tittle">精选的汽车</h3>
	               <div class="inner_tabs">
		<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">即将到来的新车</a></li>
							<li role="presentation"><a href="#tours" role="tab" id="tours-tab" data-toggle="tab" aria-controls="tours">受欢迎的车</a></li>
							<li role="presentation"><a href="#tree" role="tab" id="tree-tab" data-toggle="tab" aria-controls="tree">刚推出的车</a></li>
											...
											<div class="login-top sign-top">
												<form>
													...
													<select id="country1" onchange="change_country(this.value)" class="frm-field required">
														...
														<option value="city">夏娜</option>
														<option value="city">都柏林</option>
														<option value="city">爱丁堡</option>
														<option value="city">弗罗伦萨</option>
	   ...
	   <div class="container">
	         <div class="grid cars-main">
			  <div class="col-md-7 slide-show-w3l">
			     <!--//screen-gallery-->
				 <h3 class="tittle top">新 车</h3>
				 <h6 class="sub">好价格. 好车辆. 好服务</h6>
							<div class="car-view-slider">
					          <ul id="flexiselDemo">
							 <li>
								 <a href="upcoming.html"><img src="images/n2.jpg" alt=""/>
								  <div class="caption">
										<h3><a href="upcoming.html">福特 野马 GT 500</a></h3>
