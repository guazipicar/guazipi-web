...
<!--/web-fonts-->
<link
	href='#css?family=Open+Sans:400,600,600italic,300,300italic,700,400italic'
	rel='stylesheet' type='text/css'>
<link href='#css?family=Wallpoet' rel='stylesheet' type='text/css'>
<link href='#css?family=Ubuntu:400,500,700,300' rel='stylesheet'
	type='text/css'>
<!--//web-fonts-->
...
<div id="demo-1" class="banner-inner">
	<div class="banner-inner-dott">
		<div class="header-top">
			...
			<div class="header-left">
				...
				<div id="sidebar">
					...
					<ul>
						<li><a href="upcoming.html">New Cars <i
						...
						<li><a href="cars.html">Used Cars <i
							...
							<ul>
								...
								<li class="last"><a href="valuation.html"><span>Used
											Car Valuation</span></a></li>
								<li><a href="dealer.html"><span>Locate Dealer</span></a></li>
						...
						<li><a href="#">More <i
							...
							<ul>
								...
								<li><a href="accessories.html"><span>Car
											Accessories</span></a></li>
								<li><a href="tips.html"><span>Tips and Advices</span></a></li>
								<li class="last"><a href="help.html"><span>Privacy
											Policy</span></a></li>

							</ul></li>
						<li><a href="insurance.html">Insurance</a></li>
						<li><a href="app.html">Catchy Carz app</a>
						<li>
					</ul>
					<div id="sidebar-btn">
				...
				<div class="tag">
					<a href="#" data-toggle="modal" data-target="#myModal1"><span
						class="glyphicon glyphicon-tag"></span> 新车折扣 </a>
				</div>
				<div class="tag">
					<a href="#" data-toggle="modal" data-target="#myModal2"><span
						class="glyphicon glyphicon-log-in"></span>用户注册</a>
				</div>
			</div>
			<!-- //header-left -->
			<div class="search-box">
				<div id="sb-search" class="sb-search">
					<form action="#" method="post">
						<input name="search" class="sb-search-input"
				...
				<ul>
					...
					<li><a href="#" data-toggle="modal" data-target="#myModal4"><i
							class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Select
							Your Location</a></li>
		...
		<div class="banner-info">
			<h1>
				<a href="index.html">Catchy <span class="logo-sub">Carz</span>
				</a>
			</h1>
			<h2>
		...
		<div class="modal-content about">
			<div class="modal-header">
				...
				<div class="discount">
					...
					<form action="#" method="post">
						<select id="country5" onchange="change_country(this.value)"
							class="frm-field required">
							<option selected="selected" value="-1">-Buying Time
								Period-</option>
						...
						</select> <input type="text" class="Pin code" placeholder="Pin code"
							required="">
					</form>
				</div>
			</div>
					...
					<form action="#" method="post">
						...
						<div class="d-c">
							<span class="checkbox1"> <label class="checkbox"><input
									type="checkbox" name="" checked=""><i> </i>I agree to
				...
				<div class="login-top sign-top one">
					<form action="#" method="post">
						...
						<input type="password" name="password" class="password"
							...
							type="checkbox" id="brand1" value=""> <label for="brand1"><span></span>
							Remember me</label>
...
<!-- //location-->
<!-- /get-->
<div class="modal ab fade" id="myModal3" tabindex="-1" role="dialog"
	aria-labelledby="myModalLabel">
	<div class="modal-dialog sign" role="document">
		<div class="modal-content about">
			<div class="modal-header one">
				...
				<div class="login-top sign-top get">
					...
					<form action="#" method="post">
						...
						<input type="text" name="email" class="email" placeholder="Email"
							...
							class="password" placeholder="Password" required=""> <input
...
<!-- /search-car-->
<!-- /location-->
<div class="modal ab fade" id="myModal6" tabindex="-1" role="dialog"
	aria-labelledby="myModalLabel">
	<div class="modal-dialog sign" role="document">
		<div class="modal-content about">
			<div class="modal-header one">
			...
			<div class="modal-body about">
				<div class="login-top cars sign-top one">
					...
					<div class="car-form-pop">
						<p>
							Starts from <span>$36000</span>
						</p>
						<div class="location">
							<h3>
								Car Location: <span>Dallas</span>
							</h3>
						</div>
						<form action="#" method="post">
							...
							<input type="password" class="password" placeholder="Password"
								required=""> <input type="checkbox" id="brand2" value="">
